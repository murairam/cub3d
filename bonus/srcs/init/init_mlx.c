...
/*   Updated: 2025/09/02 21:20:13 by mmiilpal         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_game_vars(t_game *game)
{
	...
	if (!game->win)
		ft_exit_error_with_cleanup(game, "Failed to create game window");
	game->img = mlx_new_image(game->mlx, WIDTH, HEIGHT);
	if (!game->img)
		ft_exit_error_with_cleanup(game, "Failed to create main game image");
