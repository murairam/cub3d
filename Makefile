...
BONUS_SRC = main.c utils/error.c utils/free.c utils/free_utils.c parser/parser.c parser/p_utils.c \
	...
	parser/color.c parser/line.c parser/list_utils.c parser/parsing_utils.c init/init.c init/init_utils.c init/init_mlx.c init/init_textures.c init/texture_utils.c \
	...
	game_loop/render_utils.c game_loop/raycasting_utils.c game_loop/render_draw.c chalk/wall_tag.c chalk/wall_tag_utils.c \
	minimap/minimap.c minimap/minimap_draw.c minimap/minimap_walls.c minimap/minimap_player.c game_loop/move_helpers.c \
	minimap/minimap_blend.c minimap/minimap_render.c utils/free_textures.c \
	game_loop/mirror_utils.c pick_up/item_pick_up.c pick_up/item_pick_up_helper.c utils/inventory_utils.c \
	sprites/chalk_init.c sprites/chalk_animation.c sprites/chalk_render.c sprites/chalk_render2.c sprites/chalk_render3.c sprites/chalk_minimap.c sprites/chalk_utils.c sprites/chalk_visibility.c \
	doors/doors.c doors/door_utils.c game_loop/mirror.c game_loop/game_loop_printer.c thread/thread.c thread/time.c\
...
.PHONY: all clean fclean create_dirs re norm
